...
namespace HelloActor
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of HelloActor
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        Task<int> IHelloActor.GetCountAsync(CancellationToken cancellationToken)
        {
        ...
        /// <returns></returns>
        Task IHelloActor.SetCountAsync(int count, CancellationToken cancellationToken)
        {
